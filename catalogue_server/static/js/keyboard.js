function VKI_buildKeyboardInputs() {
    ...
    this.VKI_kt = "Greek";  // Default keyboard layout
    ...
    this.VKI_layout.Arabic = [ // Arabic Keyboard
        ...
        [["Shift", "Shift"], ["\u0626", "\u007e"], ["\u0621", "\u0652"], ["\u0624", "\u007d"], ["\u0631", "\u007b"], ["\u0644", "\u0644"], ["\u0649", "\u0622"], ["\u0629", "\u2019"], ["\u0648", "\u002c"], ["\u0632", "\u002e"], ["\u0638", "\u061f"], ["Alt", "Alt"]],
        [[" ", " ", " ", " "]]
    ];
    ...
    this.VKI_layout.Greek = [ // Greek Standard Keyboard
        ...
        [["Shift", "Shift"], ["<", ">"], ["\u03b6", "\u0396"], ["\u03c7", "\u03a7"], ["\u03c8", "\u03a8"], ["\u03c9", "\u03a9"], ["\u03b2", "\u0392"], ["\u03bd", "\u039d"], ["\u03bc", "\u039c"], [",", "<"], [".", ">"], ["/", "?"], ["Alt", "Alt"]],
        [[" ", " ", " ", " "]]
    ];
    ...
    this.VKI_layout.Hebrew = [ // Hebrew Standard Keyboard
        ...
        [["Shift", "Shift"], ["\u05d6", "Z"], ["\u05e1", "X"], ["\u05d1", "C"], ["\u05d4", "V"], ["\u05e0", "B"], ["\u05de", "N"], ["\u05e6", "M"], ["\u05ea", ">"], ["\u05e5", "<"], [".", "?"], ["Alt", "Alt"]],
        [[" ", " ", " ", " "]]
    ];
...
$(document).on("click",".search-keyboard",function(e){
    //check to see if the keyboard has already been opened - in which case don't open it again
    if(!$("#keyboardInputMaster").length)
    {
        e.stopPropagation();
...
//      if (!$(e.target).is('.focused')){
////          $("#keyboard-box").hide();
//          $("#keyboardInputMaster").fadeOut(222,function(){
//              $("#keyboardInputMaster").delay(2000).detach();
//          });
